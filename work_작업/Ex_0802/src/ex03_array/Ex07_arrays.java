...
public class Ex07_arrays {
	public static void main(String[] args) {
		...
		//배열 arr02의 값 변경
		arr02[1] = 10;
		//배열의 이름은 주소값으로 저장되는데 얕은복사를 하면 같은 주소를 가져간다
		...
		int[] newCards2 = Arrays.copyOf(cards, cards.length);//원본배열의 길이만큼 복사해서 변수에 넣는다
		...
		//cards 배열의 처음, newCards3 처음부터 cards배열의 길이만큼 복사
		newCards[1] = 100;
