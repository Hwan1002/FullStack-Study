...
public class Ex01_Enum {
	public static void main(String[] args) {
		//values() -> 열거형 안에 들어있는 내용들을 enum타입의 배열로 반환
		...
		for(Item n : items) {
			System.out.println("name" +n.name()+",ordinal ="+ n.ordinal());
		}
		...
		//초과,미만,이상,이하와 같은 비교 연산자는 사용할 수 없다.
		...
		//열거형 객체를 직접 만드는것은 불가능하다.(생성자가 private이기 때문에)
		//열거형의 객체는 public이 안되고 오로지 private만 가능하다
