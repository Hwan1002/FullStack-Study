...
public class Ex01_Calendar {
	...
	public static void main(String[] args) {
		...
		//Calender cal = new Calendar(); 캘린더 객체생성은 이런식으로 만들 수 없다.
		Calendar cal = Calendar.getInstance();
		
		//Calendar 클래스의 속성
		//YEAR,MONTH,DATE 연,월(0-11),일(1,31)을 나타내는 상수
		//DAY_OF_MONTH 현재 달의 몇 번째 날인지를 나타내는 상수
		//DAY_OF_WEEK 현재 주의 몇번째 요일인지 나타내는 상수(1-7),
		//1이 일요일
		...
		//WEEK_OF_MONTH 현재 달의 몇 번째 주 인지를 나타내는 상수
		//WEEK_OF_YEAR 현재 해의 몇 번째 주 인지를 나타내는 상수
