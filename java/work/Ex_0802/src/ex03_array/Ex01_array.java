...
public class Ex01_array {
	public static void main(String[] args) {
		int[] arr; //배열의 선언
		//배열 arr에 4개의 데이터를 저장하기 위한 공간을 메모리에 할당
		arr = new int [4];
		...
		//선언한 후 값을 대입 해야하는 경우에는
		//아래와 같은 방법이 가능하다.
		int[] arr4;
		arr4 = new int[] {1,2,3,4,5};
		
		//배열명을 출력하면 배열이 갖고있는 주소값을 출력한다.
		//변수가 갖고있는 값을 출력하는것과 같은 원리이다.
		System.out.println(arr);
		
		//배열의 특징
		//배열을 만들때 크기를 꼭 지정해야한다.
		...
		//우리는 배열이 지니는 값들의 위치값을 인덱스(index)라 부른다.
		//인덱스는 배열의 공간마다 붙여진 번호로 0부터 시작하여 순차적으로 증가한다.  
	}
}
